...
#################################################################
# Program                                                       #
#   Generate g09 input file by extracting the necessary info.   #
#   (e.g. level of theory and structure coordinate) from the    #
#   IRC path.                                                   #
#                                                               #
# I/O part                                                      #
#     input:                                                    #
...
# History                                                       #
#   2018/07/02, Grace                                           #
#   2018/07/05, Grace, separate force and freq in the route     #
#               section.                                        #
#################################################################
...
function getPES(){
    ...
    do 
        ...
        sed -n "$startLine,$endLine p" $1 \
            | grep -A $(($natoms+2)) 'Center     Atomic      Atomic             Coordinates (Angstroms)'  \
